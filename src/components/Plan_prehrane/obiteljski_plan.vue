<template>
  <div>
    <div
      class="calorie p-4 mx-auto mt-5 w-75"
      ...
      <div class="rounded-lg" id="formContent">
        <div style="background-color: #f8f8f8; !important;  ">
          ...
          <b-form @submit.prevent="spremiPoTjednu" class="mx-4 text-center ">
            ...
            <b-input-group
              v-if="onclick() && radni_tjedan.dan"
              class=" mx-auto my-4 "
              style="width:210px;"
            >
              <b-form-select id="input-1"> </b-form-select>
            </b-input-group>

            <b-input-group
              v-if="
                odabirObroka.DorucakRucakVecera == 'Doručak' && radni_tjedan.dan
              "
              class=" mx-auto my-4 "
              style="width:210px;"
            >
            ...
            <b-input-group
              v-if="
                odabirObroka.DorucakRucakVecera == 'Ručak' && radni_tjedan.dan
              "
              class=" mx-auto my-4 "
              style="width:210px;"
            >
            ...
            <b-input-group
              v-if="
                odabirObroka.DorucakRucakVecera == 'Večera' && radni_tjedan.dan
              "
              class=" mx-auto my-4 "
              style="width:210px;"
            >
            ...
            <b-alert
              v-if="radni_tjedan.dan"
              class="text-center mx-auto pt-4"
              style="background-color:#30CFC0; border-radius:25px; max-width:200px; color:white;"
            ...
            <b-button
              v-if="radni_tjedan.dan && odabirObroka.DorucakRucakVecera"
              type="submit"
              @click="showAlert"
              class="rounded-lg py-2 px-1  "
              style="font-size:20px; width:100px; height:40px;"
              variant="info"
              >Spremi</b-button
            >
          </b-form>
      ...
      <div class="rounded-lg" id="formContent">
        <div style="background-color: #f8f8f8; !important;  ">
          ...
          <b-form @submit.prevent="spremiPoTjednu1" class="mx-4 text-center ">
            ...
            <b-input-group
              v-if="onclick1() && radni_tjedan.vikend_dan"
              class=" mx-auto my-4 "
              style="width:210px;"
            >
              <b-form-select id="input-1" :options="hrana"> </b-form-select>
            </b-input-group>

            <b-input-group
              v-if="
                odabirObroka.DorucakRucakVecera1 == 'Doručak' &&
                  radni_tjedan.vikend_dan
              "
              class=" mx-auto my-4 "
              style="width:210px;"
            >
            ...
            <b-input-group
              v-if="
                odabirObroka.DorucakRucakVecera1 == 'Ručak' &&
                  radni_tjedan.vikend_dan
              "
              class=" mx-auto my-4 "
              style="width:210px;"
            ...
            <b-input-group
              v-if="
                odabirObroka.DorucakRucakVecera1 == 'Večera' &&
                  radni_tjedan.vikend_dan
              "
              class=" mx-auto my-4 "
              style="width:210px;"
            ...
            <b-button
              v-if="radni_tjedan.vikend_dan && odabirObroka.DorucakRucakVecera1"
              type="submit"
              @click="showAlert1"
              class="rounded-lg py-2 px-1  "
              style="font-size:20px; width:100px; height:40px;"
...
export default {
  ...
  data() {
    return {
      ...
      vikend_dan: [{ text: "Odaberi dan", value: null }, "Subota", "Nedjelja"],
    };
  },
  ...
  methods: {
    ...
    spremiPoTjednu() {
      if (
        this.varijante.rucak ||
        this.varijante.dorucak ||
        (this.varijante.vecera && this.odabirObroka.DorucakRucakVecera)
      ) {
        ...
        if (
          this.radni_tjedan.dan == "Ponedjeljak" &&
          this.odabirObroka.DorucakRucakVecera == "Doručak"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            Pdorucak: this.varijante.dorucak,
          };
          console.log(NewSpremiPoTjednu);

          Service.patch(
            `/SpremiTjedan/${this.auth.userEmail}`,
            NewSpremiPoTjednu
          ).then((result) => {
            console.log(result);
          });
          ...
          this.radni_tjedan.dan == "Ponedjeljak" &&
          this.odabirObroka.DorucakRucakVecera == "Ručak"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            Prucak: this.varijante.rucak,
          };
          ...
          this.radni_tjedan.dan == "Ponedjeljak" &&
          this.odabirObroka.DorucakRucakVecera == "Večera"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            Pvecera: this.varijante.vecera,
          };
          ...
          this.radni_tjedan.dan == "Utorak" &&
          this.odabirObroka.DorucakRucakVecera == "Doručak"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            Udorucak: this.varijante.dorucak,
          };
          ...
          this.radni_tjedan.dan == "Srijeda" &&
          this.odabirObroka.DorucakRucakVecera == "Doručak"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            Sdorucak: this.varijante.dorucak,
          };
          ...
          this.radni_tjedan.dan == "Četvrtak" &&
          this.odabirObroka.DorucakRucakVecera == "Doručak"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            Cdorucak: this.varijante.dorucak,
          };
          ...
          this.radni_tjedan.dan == "Petak" &&
          this.odabirObroka.DorucakRucakVecera == "Doručak"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            PEdorucak: this.varijante.dorucak,
          };
          ...
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            PEvecera: this.varijante.vecera,
          };
        ...
        (!this.odabirObroka.DorucakRucakVecera && !this.varijante.rucak) ||
        !this.varijante.dorucak ||
        !this.varijante.vecera
      ) {
    ...
    spremiPoTjednu1() {
      if (
        (this.odabirObroka.DorucakRucakVecera1 && this.varijante.rucak) ||
        this.varijante.dorucak ||
        this.varijante.vecera
      ) {
        ...
        if (
          this.radni_tjedan.vikend_dan == "Subota" &&
          this.odabirObroka.DorucakRucakVecera1 == "Doručak"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            SUdorucak: this.varijante.dorucak,
          };
          ...
          this.radni_tjedan.vikend_dan == "Subota" &&
          this.odabirObroka.DorucakRucakVecera1 == "Ručak"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            SUrucak: this.varijante.rucak,
          };
          ...
          this.radni_tjedan.vikend_dan == "Subota" &&
          this.odabirObroka.DorucakRucakVecera1 == "Večera"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            SUvecera: this.varijante.vecera,
          };
          ...
          this.radni_tjedan.vikend_dan == "Nedjelja" &&
          this.odabirObroka.DorucakRucakVecera1 == "Doručak"
        ) {
          let NewSpremiPoTjednu = {
            radni_dan: this.radni_tjedan.dan,
            Ndorucak: this.varijante.dorucak,
          };
    ...
    onclick1() {
      if (this.odabirObroka.DorucakRucakVecera1 === "Doručak") {
        this.feedback1 =
          "Odabrali ste doručak i imate na raspolaganju 5 varijanti";
      } else if (this.odabirObroka.DorucakRucakVecera1 === "Ručak") {
        this.feedback1 =
          "Odabrali ste ručak i imate na raspolaganju 5 varijanti";
      } else if (this.odabirObroka.DorucakRucakVecera1 === "Večera") {
        this.feedback1 =
          "Odabrali ste večeru i imate na raspolaganju 5 varijanti";
      } else {
        this.feedback1 = null;
      }
    },
